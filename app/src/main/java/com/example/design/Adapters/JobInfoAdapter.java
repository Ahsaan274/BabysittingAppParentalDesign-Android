...
public class JobInfoAdapter extends ArrayAdapter<String> {
    String[] Names,Ages,Gender;
    int[] images;
    Context mContext;

    public JobInfoAdapter(Context context, String[] Names, String[] Ages,String[] gender,int[] images){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mViewHolder = (JobInfoAdapter.ViewHolder) convertView.getTag();
        }
